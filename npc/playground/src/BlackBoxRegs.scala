...
class BlackBoxRegs extends BlackBox with HasBlackBoxInline {
  ...
  setInline(
    ...
    """import "DPI-C" function void set_gpr_ptr(input logic [63:0] a []);
      ...
      |  input [63:0] regs_30,
      |  input [63:0] regs_31,
      |  input [63:0] csrregs_0,
      |  input [63:0] csrregs_1,
      |  input [63:0] csrregs_2,
      |  input [63:0] csrregs_3,
      |  input [63:0] csrregs_4,
      |  input [63:0] csrregs_5,
      |  input [63:0] pc, 
      |  input [4:0] waddr,
      |  input [63:0] wdata
      |);
      ...
      |  assign regs[32] = pc;
      |  assign regs[33] = csrregs_0;
      |  assign regs[34] = csrregs_1;
      |  assign regs[35] = csrregs_2;
      |  assign regs[36] = csrregs_3;
      |  assign regs[37] = csrregs_4;
      |  assign regs[38] = csrregs_5;
