...
class InstContorlDecoder extends Module {
  val table = TruthTable(
    Map(
		  ...
		  BitPat("b??????? ????? ????? ??? ????? 00101 11") -> BitPat("b010 0 ? 01 1 00000 000 0 00 ?? 000 ?? 0 0 00 ? 00"), // auipc
		  ...
		  BitPat("b??????? ????? ????? ??? ????? 11011 11") -> BitPat("b100 0 ? ?? ? 00000 010 0 00 ?? 111 00 0 0 00 ? 00"), // jal
		  ...
		  BitPat("b??????? ????? ????? ??? ????? 01101 11") -> BitPat("b010 0 ? 10 1 00000 000 0 00 ?? 000 ?? 0 0 00 ? 00"), // lui
		  ...
		  BitPat("b??????? ????? ????? 110 ????? 00100 11") -> BitPat("b001 0 ? 00 1 01001 000 0 00 ?? 000 ?? 0 0 00 ? 00"), // ori
		  ...
		  BitPat("b000000? ????? ????? 001 ????? 00100 11") -> BitPat("b001 0 ? 00 1 01110 000 0 00 ?? 000 ?? 0 0 00 ? 00"), // slli
		  BitPat("b0000000 ????? ????? 001 ????? 00110 11") -> BitPat("b001 1 ? 00 1 01110 000 1 00 ?? 000 ?? 0 0 00 ? 00"), // slliw
		  ...
		  BitPat("b010000? ????? ????? 101 ????? 00100 11") -> BitPat("b001 0 ? 00 1 01111 000 0 00 ?? 000 ?? 0 0 00 ? 00"), // srai
		  BitPat("b0100000 ????? ????? 101 ????? 00110 11") -> BitPat("b001 1 ? 00 1 01111 000 1 00 ?? 000 ?? 0 0 00 ? 00"), // sraiw
		  ...
		  BitPat("b000000? ????? ????? 101 ????? 00100 11") -> BitPat("b001 0 ? 00 1 10000 000 0 00 ?? 000 ?? 0 0 00 ? 00"), // srli
		  BitPat("b0000000 ????? ????? 101 ????? 00110 11") -> BitPat("b001 1 ? 00 1 10001 000 1 00 ?? 000 ?? 0 0 00 ? 00"), // srliw
		  ...
		  BitPat("b??????? ????? ????? 100 ????? 00100 11") -> BitPat("b001 0 ? 00 1 10010 000 0 00 ?? 000 ?? 0 0 00 ? 00"), // xori
		  BitPat("b??????? ????? ????? 011 ????? 11100 11") -> BitPat("b001 0 ? ?? ? 00000 110 0 00 ?? 000 ?? 0 0 01 0 00"), // csrrc
		  BitPat("b??????? ????? ????? 111 ????? 11100 11") -> BitPat("b001 0 ? ?? ? 00000 110 0 00 ?? 000 ?? 0 0 01 1 00"), // csrrci
		  BitPat("b??????? ????? ????? 010 ????? 11100 11") -> BitPat("b001 0 ? ?? ? 00000 110 0 00 ?? 000 ?? 0 0 10 0 00"), // csrrs
		  BitPat("b??????? ????? ????? 110 ????? 11100 11") -> BitPat("b001 0 ? ?? ? 00000 110 0 00 ?? 000 ?? 0 0 10 1 00"), // csrrsi
		  BitPat("b??????? ????? ????? 001 ????? 11100 11") -> BitPat("b001 0 ? ?? ? 00000 110 0 00 ?? 000 ?? 0 0 11 0 00"), // csrrw
		  BitPat("b??????? ????? ????? 101 ????? 11100 11") -> BitPat("b001 0 ? ?? ? 00000 110 0 00 ?? 000 ?? 0 0 11 1 00"), // csrrwi
		  BitPat("b0000000 00001 00000 000 00000 11100 11") -> BitPat("b110 0 ? ?? ? 00000 001 ? 00 ?? 000 ?? 1 0 00 ? 00"), // ebreak
		  BitPat("b0000000 00000 00000 000 00000 11100 11") -> BitPat("b110 0 ? ?? ? 00000 001 ? 00 ?? 111 10 0 0 00 ? 01"), // ecall
		  BitPat("b0011000 00010 00000 000 00000 11100 11") -> BitPat("b001 0 ? ?? ? 00000 001 ? 00 ?? 111 10 0 0 00 ? 10"), // mret
	),
    BitPat("b110 0 ? ?? ? 00000 001 ? 00 ?? 000 ?? 0 1 00 ? 00") // inv
  )
