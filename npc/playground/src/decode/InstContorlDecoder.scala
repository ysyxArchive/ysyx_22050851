...
class InstContorlDecoder extends Module {
  val table = TruthTable(
    Map(
		  ...
		  BitPat("b0000001 ????? ????? 101 ????? 01110 11") -> BitPat("b000 1 1 00 0 00101 1 000 0 00 ?? 000 ? 0 0 00 ? 0 00"), // divuw
		  ...
		  BitPat("b0000001 ????? ????? 111 ????? 01110 11") -> BitPat("b000 1 1 00 0 01100 1 000 0 00 ?? 000 ? 0 0 00 ? 0 00"), // remuw
