...
class InstContorlDecoder extends Module {
  val table = TruthTable(
    Map(
		  ...
		  BitPat("b??????? ????? ????? 000 ????? 11000 11") -> BitPat("b011 0 0 00 0 00010 001 0 00 ?? 001 00 0 0 00 ? 00"), // beq
		  BitPat("b??????? ????? ????? 101 ????? 11000 11") -> BitPat("b011 0 0 00 0 00010 001 0 00 ?? 010 00 0 0 00 ? 00"), // bge
		  BitPat("b??????? ????? ????? 111 ????? 11000 11") -> BitPat("b011 0 0 00 0 00010 001 0 00 ?? 011 00 0 0 00 ? 00"), // bgeu
		  BitPat("b??????? ????? ????? 100 ????? 11000 11") -> BitPat("b011 0 0 00 0 00010 001 0 00 ?? 100 00 0 0 00 ? 00"), // blt
		  BitPat("b??????? ????? ????? 110 ????? 11000 11") -> BitPat("b011 0 0 00 0 00010 001 0 00 ?? 101 00 0 0 00 ? 00"), // bltu
		  BitPat("b??????? ????? ????? 001 ????? 11000 11") -> BitPat("b011 0 0 00 0 00010 001 0 00 ?? 110 00 0 0 00 ? 00"), // bne
		  ...
		  BitPat("b??????? ????? ????? 000 ????? 01000 11") -> BitPat("b101 0 0 00 1 00000 001 0 11 00 000 ?? 0 0 00 ? 00"), // sb
		  BitPat("b??????? ????? ????? 011 ????? 01000 11") -> BitPat("b101 0 0 00 1 00000 001 0 11 01 000 ?? 0 0 00 ? 00"), // sd
		  BitPat("b??????? ????? ????? 001 ????? 01000 11") -> BitPat("b101 0 0 00 1 00000 001 0 11 10 000 ?? 0 0 00 ? 00"), // sh
		  ...
		  BitPat("b??????? ????? ????? 010 ????? 01000 11") -> BitPat("b101 0 0 00 1 00000 001 0 11 11 000 ?? 0 0 00 ? 00"), // sw
		  ...
		  BitPat("b0000000 00001 00000 000 00000 11100 11") -> BitPat("b110 0 0 ?? ? 00000 001 0 00 ?? 000 ?? 1 0 00 ? 00"), // ebreak
		  BitPat("b0000000 00000 00000 000 00000 11100 11") -> BitPat("b110 0 0 ?? ? 00000 001 0 00 ?? 111 10 0 0 00 ? 01"), // ecall
		  BitPat("b0011000 00010 00000 000 00000 11100 11") -> BitPat("b001 0 0 ?? ? 00000 001 0 00 ?? 111 10 0 0 00 ? 10"), // mret
	),
    BitPat("b110 0 0 ?? ? 00000 001 0 00 ?? 000 ?? 0 1 00 ? 00") // inv
  )
