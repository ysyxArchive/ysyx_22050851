...
class InstContorlDecoder extends Module {
  val table = TruthTable(
    Map(
		  ...
		  BitPat("b0000000 ????? ????? 101 ????? 00110 11") -> BitPat("b001 1 0 00 1 1011 0 00 1 00 ?? 000 ? 0 0"), // srliw
		  BitPat("b0000000 ????? ????? 101 ????? 01110 11") -> BitPat("b000 1 0 00 0 1011 0 00 1 00 ?? 000 ? 0 0"), // srlw
		  ...
		  BitPat("b0000000 ????? ????? 100 ????? 01100 11") -> BitPat("b000 0 0 00 0 1100 0 00 0 00 ?? 000 ? 0 0"), // xor
		  BitPat("b??????? ????? ????? 100 ????? 00100 11") -> BitPat("b001 0 0 00 1 1100 0 00 0 00 ?? 000 ? 0 0"), // xori
