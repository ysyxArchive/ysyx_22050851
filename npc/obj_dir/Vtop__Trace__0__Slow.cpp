...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+1,"in", false,-1);
    tracep->declBit(c+5,"clk", false,-1);
    tracep->declBit(c+6,"rst", false,-1);
    tracep->declBit(c+2,"out", false,-1);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelf->top__DOT____Vcellout__mycounter1__out));
    bufp->fullBit(oldp+2,(vlSelf->top__DOT____Vcellout__mycounter2__out));
    bufp->fullBit(oldp+3,(vlSelf->top__DOT____Vcellout__mycounter3__out));
    bufp->fullBit(oldp+4,(vlSelf->top__DOT____Vcellout__mycounter4__out));
